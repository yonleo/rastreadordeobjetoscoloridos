...
python main.py video.mp4 -c vermelho azul
...
- **Calibração de câmera** — compensar distorção de lente para medições métricas
- **Exportar CSV** — gravar posição do centróide por frame para análise posterior
